    ...
    <template v-else-if="data">
      ...
      <div class="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <UCard>
          ...
          <p class="text-3xl font-bold mt-1 text-gray-900 dark:text-white">
            {{ data.kpis.otsActivas }}
          </p>
          <p class="text-xs text-gray-400 mt-1">
            de {{ data.kpis.otsTotal }} totales
          </p>
        </UCard>
        ...
        <UCard>
          ...
          <p
            ...
            :class="entregasColor(data.kpis.entregasPorcentaje)"
          >
            {{ data.kpis.entregasPorcentaje }}%
          </p>
          <p class="text-xs text-gray-400 mt-1">
            {{ data.kpis.entregasATiempo }} de {{ data.kpis.entregasTotal }}
          </p>
        </UCard>
        ...
        <UCard>
          ...
          <p class="text-3xl font-bold mt-1 text-gray-900 dark:text-white">
            {{ data.kpis.noConformidadesTotal }}
          </p>
          <NuxtLink
            to="/indicadores"
            class="text-xs text-primary mt-1 block hover:underline"
          >Ver indicadores →</NuxtLink>
        </UCard>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <UCard>
          ...
          <div
            v-else
            class="divide-y divide-gray-100 dark:divide-gray-800 -mx-4 -mt-2"
          >
            <NuxtLink
            ...
            >
              ...
              <div class="ml-3 shrink-0 text-right">
                ...
                <p
                  class="text-xs mt-1"
                  :class="ot.isOverdue ? 'text-red-500 font-medium' : 'text-gray-400'"
                >
        ...
        <UCard>
          ...
          <div
            v-if="data.proximosMantenimientos.length === 0"
            class="text-sm text-gray-500 py-2"
          >
